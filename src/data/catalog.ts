...
export const CATEGORIES: Category[] = [
  {
    ...
    products: [
      { id: "c1_1", name: "חצי בגט", unit: "unit", price: 3.9, minQty: 1, step: 1, quickAdd: 5, available: true, weightGrams: 250 },
      { id: "c1_2", name: "בגט ארוך", unit: "unit", price: 6.5, minQty: 1, step: 1, quickAdd: 5, available: true, weightGrams: 400 },
      { id: "c1_3", name: "בגט מחמצת", unit: "unit", price: 8.9, minQty: 1, step: 1, quickAdd: 5, available: true, weightGrams: 500 },
      ...
      { id: "c1_8", name: "לחם הבית", unit: "unit", price: 12.9, minQty: 1, step: 1, quickAdd: 5, available: true, weightGrams: 750 },
      { id: "c1_9", name: "לחם מחמצת", unit: "unit", price: 15.9, minQty: 1, step: 1, quickAdd: 5, available: true, weightGrams: 900, note: "מחמצת טבעית, זמן אפייה ארוך" },
      { id: "c1_10", name: "לחם ללא גלוטן", unit: "unit", price: 18.9, minQty: 1, step: 1, quickAdd: 2, available: true, weightGrams: 500, note: "ללא גלוטן — מיוצר במתקן נפרד" },
      ...
      { id: "c1_14", name: "לחם שחור פרוס", unit: "unit", price: 11.9, minQty: 1, step: 1, quickAdd: 5, available: true, weightGrams: 500 },
  ...
  },
  {
    ...
    products: [
      { id: "c2_1", name: "לחמניית שומשום", unit: "unit", price: 1.4, minQty: 1, step: 1, quickAdd: 25, available: true, weightGrams: 60 },
      { id: "c2_2", name: "לחמניית המבורגר", unit: "unit", price: 1.7, minQty: 1, step: 1, quickAdd: 16, available: true, weightGrams: 80 },
      ...
      { id: "c2_18", name: "שמינייה מתוק 90 גרם", unit: "unit", price: 1.5, minQty: 1, step: 1, quickAdd: 25, available: true, weightGrams: 90 },
